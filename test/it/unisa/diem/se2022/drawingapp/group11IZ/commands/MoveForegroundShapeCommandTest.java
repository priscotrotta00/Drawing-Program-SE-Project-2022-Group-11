...
public class MoveForegroundShapeCommandTest {
    ...
    public void executeTest1() {
        ...
        this.foregroundCommand = new MoveForegroundShapeCommand(canvas, line);
    ...
    public void executeTest2() {
        ...
        this.foregroundCommand = new MoveForegroundShapeCommand(canvas, ellipse);
        this.foregroundCommand.execute();
    }
    ...
    public void executeTest3() {
        ...
        this.foregroundCommand = new MoveForegroundShapeCommand(canvas, rectangle);
        this.foregroundCommand.execute();
    }
