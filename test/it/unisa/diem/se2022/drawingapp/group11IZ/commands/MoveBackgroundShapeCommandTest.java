...
public class MoveBackgroundShapeCommandTest {
    ...
    public void executeTest1() {
        ...
        this.backgroundCommand = new MoveBackgroundShapeCommand(canvas, line);
    ...
    public void executeTest2() {
        ...
        this.backgroundCommand = new MoveBackgroundShapeCommand(canvas, ellipse);
        this.backgroundCommand.execute();
    }
    ...
    public void executeTest3() {
        ...
        this.backgroundCommand = new MoveBackgroundShapeCommand(canvas, rectangle);
        this.backgroundCommand.execute();
    }
    ...
    public void executeTest4() {
        ...
        MyEnhancedLine line = new MyEnhancedLine();
        //add in controller
        CreateShapeCommand createShapeE = new CreateShapeCommand(this.canvas, ellipse);
        CreateShapeCommand createShapeR = new CreateShapeCommand(this.canvas, rectangle);
        CreateShapeCommand createShapeL = new CreateShapeCommand(this.canvas, line);
