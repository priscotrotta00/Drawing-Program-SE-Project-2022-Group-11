...
public class DrawEllipseToolTest {
    ...
    public void testCreateShapeCirlce(){
        Ellipse test = (Ellipse) tool.createShape(10, 10, 30, 30, Color.BLACK, Color.WHITE);
        ...
        Assert.assertEquals("Test fill color", Color.BLACK.toString(), test.getStroke().toString());
    }
       
    @Test
    public void testCreateShapeLongX(){
        Ellipse test = (Ellipse) tool.createShape(10, 10, 30, 20, Color.BLACK, Color.WHITE);
    ...
    public void testCreateShapeLongY(){
        Ellipse test = (Ellipse) tool.createShape(10, 10, 20, 50, Color.BLACK, Color.WHITE);
    ...
    public void testCreateShapePoint(){
        Ellipse test = (Ellipse) tool.createShape(10, 10, 10, 10, Color.BLACK, Color.WHITE);
    ...
    public void testCreateShapeHLine(){
        Ellipse test = (Ellipse) tool.createShape(0, 10, 100, 10, Color.BLACK, Color.WHITE);
    ...
    public void testCreateShapeVLine(){
        Ellipse test = (Ellipse) tool.createShape(0, 0, 0, 100, Color.BLACK, Color.WHITE);
    ...
    public void testCreateShapeNegativeCoordinates(){
        Ellipse test = (Ellipse) tool.createShape(-30, -20, -10, -10, Color.BLACK, Color.WHITE);
    ...
    public void testCreateShapeDifferentColors1(){
        Ellipse test = (Ellipse) tool.createShape(-30, -20, 10, 10, Color.RED, Color.PURPLE);
    ...
    public void testCreateShapeDifferentColors2(){
        Ellipse test = (Ellipse) tool.createShape(-30, -20, 10, 10, Color.web("#f68"), Color.color(1, 0.5, 0.45));
